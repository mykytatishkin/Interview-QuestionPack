...
**Навигация:** [[../Java 2025-2026|← Java]] · [[../Topics/topics_summary|Шпаргалка]]
...
Ответь своими словами (2–5 предложений). Потом сверься с эталоном и [[../Topics/topics_summary|шпаргалкой]].
...
> 
> ### Часть A
> 1. **B** — Одинаковый `hashCode` не обязан означать равенство по `equals` (коллизии). См. [[../Topics/topics_summary#1. hashCode() и equals()]].
> 2. **B** — Один `null`-ключ, много `null`-значений.
> 3. **B** — Красно-чёрное дерево при ≥8 элементах в бакете (и capacity ≥ 64). См. [[../Topics/topics_summary#2. HashMap]].
...
> 6. **B** — Видимость и запрет переупорядочивания; составные операции не атомарны. См. [[../Topics/topics_summary#4. JMM (Java Memory Model)]].
...
> Сначала реши тест сам, затем разверни эталоны и сверь ответы. Ошибки и уточнения можно записывать в отдельные заметки.
