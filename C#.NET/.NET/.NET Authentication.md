...
**Навигация:** [[README|← .NET]] · [[.NET Middleware|Предыдущая: Middleware]] · [[../MS SQL/README|→ MS SQL]]
...
- [[.NET Middleware|Предыдущая тема: Middleware]]
- [[../MS SQL/README|→ Перейти к MS SQL темам]] (после изучения .NET)
...
3. Переходи к [[../MS SQL/README|MS SQL темам]]
