...
**Навигация:** [[README|← .NET]] · [[.NET Middleware|Следующая: Middleware]]
...
- [[README|← Назад к списку тем .NET]]
- [[.NET Middleware|Следующая тема: Middleware]] (изучай последовательно)
...
3. Проверь знания в [[../Generated tests/dotnet_test|Generated Tests]]
4. Переходи к [[.NET Middleware|Middleware]]
