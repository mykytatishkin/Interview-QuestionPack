...
**Навигация:** [[../../README|← C#.NET]] · [[basics|Основы C#]] · [[../patterns/solid|SOLID]]

---

## 📚 Содержание

1. [Основные принципы ООП](#1-основные-принципы-ооп)
2. [Абстрактные классы](#2-абстрактные-классы)
3. [Интерфейсы](#3-интерфейсы)
4. [Конструкторы](#4-конструкторы)
5. [Свойства и индексаторы](#5-свойства-и-индексаторы)
6. [Модификаторы доступа](#6-модификаторы-доступа)
7. [Виртуальные методы и переопределение](#7-виртуальные-методы-и-переопределение)
8. [Статические члены](#8-статические-члены)

> [!tip] Связанные темы
> ООП тесно связан с [[../patterns/solid|SOLID принципами]] и [[../patterns/gof|паттернами проектирования]]
...
- **Современные практики:** использование интерфейсов для DI, применение SOLID

---

## 🔗 Связанные темы

- [[basics|Основы C#]] — база для ООП
- [[../patterns/solid|SOLID принципы]] — применение ООП в проектировании
- [[../patterns/gof|GoF паттерны]] — конкретные решения на основе ООП
- [[generics|Generics]] — обобщенное программирование с ООП

---

## 📖 Рекомендуемый порядок изучения

1. Изучи этот материал
2. Переходи к [[../patterns/solid|SOLID принципам]]
3. Изучи [[../patterns/gof|GoF паттерны]]
4. Практикуйся на практических задачах
